...
/**
 * The type User Registration content validator
 * that validates the input of the
 * user at the user registration fragment.
 */
public class UserRegistrationFragmentContentValidator {
    ...
    /**
     * The constant ATTRIBUTE_PASSWORD_REPEATED.
     */
    public static final String ATTRIBUTE_PASSWORD_REPEATED = "passwordRepeated";
    /**
     * The constant ATTRIBUTE_USERNAME_INVALID.
     */
    public static final String ATTRIBUTE_USERNAME_INVALID = "userNameInvalid";
    /**
     * The constant ATTRIBUTE_USERNAME_BLANK.
     */
    public static final String ATTRIBUTE_USERNAME_BLANK = "userNameBlank";
    /**
     * The constant ATTRIBUTE_PASSWORD_INVALID.
     */
    public static final String ATTRIBUTE_PASSWORD_INVALID = "passwordInvalid";
    /**
     * The constant ATTRIBUTE_PASSWORD_BLANK.
     */
    public static final String ATTRIBUTE_PASSWORD_BLANK = "passwordBlank";
    /**
     * The constant ATTRIBUTE_PASSWORD_REPEATED_NOT_EQUAL.
     */
    public static final String ATTRIBUTE_PASSWORD_REPEATED_NOT_EQUAL = "passwordRepeatedNotEqual";
    /**
     * The constant ATTRIBUTE_PASSWORD_REPEATED_BLANK.
     */
    public static final String ATTRIBUTE_PASSWORD_REPEATED_BLANK = "passwordRepeatedBlank";
     ...
     */
    public void validate(UserRegistrationContent userRegistrationContent, ValidationError validationError) {
        checkUserName(userRegistrationContent, validationError);
        checkPassword(userRegistrationContent, validationError);
        checkPasswordRepeated(userRegistrationContent, validationError);
    }
     ...
     * @param validationError  the validation error
     */
    private void checkUserName(UserRegistrationContent userRegistrationContent, ValidationError validationError) {
     ...
     * @param validationError  the validation error
     */
    private void checkPassword(UserRegistrationContent userRegistrationContent, ValidationError validationError) {
    ...
    /**
     * Method that checks the validity of the password repeated.
     *
     * @param userRegistrationContent the location contents
     * @param validationError  the validation error
     */
    private void checkPasswordRepeated(UserRegistrationContent userRegistrationContent, ValidationError validationError) {
        if(!passwordRepeatedIsNotBlank(userRegistrationContent.getPasswordRepeated())) {
            validationError.rejectValue(ATTRIBUTE_PASSWORD_REPEATED, ATTRIBUTE_PASSWORD_REPEATED_BLANK);
        } else if(!validatePasswordRepeated(userRegistrationContent.getPasswordRepeated(), userRegistrationContent.getPassword())) {
            validationError.rejectValue(ATTRIBUTE_PASSWORD_REPEATED, ATTRIBUTE_PASSWORD_REPEATED_NOT_EQUAL);
        }
    }
    ...
    /**
     * Method that validates the passwordRepeated.
     *
     * @param passwordRepeated the passwordRepeated
     * @param password the password
     * @return <code>true</code> if the passwordRepeated is valid
     */
    private boolean validatePasswordRepeated(String passwordRepeated, String password) {
    ...
    /**
     * Method that checks if the passwordRepeated is not blank.
     *
     * @param passwordRepeated the passwordRepeated
     * @return <code>true</code> if the passwordRepeated is not blank
     */
    private boolean passwordRepeatedIsNotBlank(String passwordRepeated) {
        return !TextUtils.isEmpty(passwordRepeated);
    }
}
