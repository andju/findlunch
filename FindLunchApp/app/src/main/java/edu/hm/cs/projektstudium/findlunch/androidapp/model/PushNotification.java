...
public class PushNotification{
     ...
     * @param gcmToken GCM Token generated by the App
     ...
     */
    public PushNotification(String gcmToken, String title, float latitude, float longitude, int radius, User user, List<DayOfWeek> dayOfWeeks, List<KitchenType> kitchenTypes) {
    ...
    /**
     * Empty constructor for PushNotification Object.
     */
